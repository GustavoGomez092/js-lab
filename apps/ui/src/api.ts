...
export interface MainApi {
  ...
  /** The page reached `dom-ready`: Main may inject script into it now. */
  webRunnerReady(tabId: string): void;
  /** The webview died, or was torn down by something other than Main's own `webRunner.destroy`. */
  webRunnerExit(tabId: string): void;
